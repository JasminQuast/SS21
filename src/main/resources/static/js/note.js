...
<div>
    ...
    <section>
    <input type="radio" v-model="emotion" value="1">
    ...
    <input type="radio" v-model="emotion" value="2">
    ...
    <input type="radio" v-model="emotion" value="3">
    ...
    <input type="radio" v-model="emotion" value="4">
    ...
    <input type="radio" v-model="emotion" value="5">
    ...
    <input type="radio" v-model="emotion" value="6">
